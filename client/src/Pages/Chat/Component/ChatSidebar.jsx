      ...
      >
        ...
        <div className="space-y-4 md:space-y-6 mt-12 md:mt-0">
          <div className="w-13 h-13 bg-gradient-to-br from-orange-500 to-blue-500 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
            <Link to="/profile">
              <img
                src={userData ? `${apiUrl}${userData.avatar}` : default_user_image}
                alt="Profile"
                ...
                onError={(e) => {
                  e.target.src = "/placeholder.svg?height=44&width=44"
                }}
              />
            </Link>
          </div>
          ...
          <div className="flex flex-col space-y-3 md:space-y-4">
            <button
              ...
              className={`p-3 rounded-xl transition-all duration-200 hover:scale-110 shadow-md touch-manipulation ${
                selected === "groups"
